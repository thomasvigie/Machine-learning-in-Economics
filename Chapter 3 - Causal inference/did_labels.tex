...
xtick = {0, 15, 50, 85} ,
xticklabels={$0$, $\bm{ T = 0 }$, Treatment,  $\bm{ T = 1 }$},
ytick = { },
yticklabels={ },
...
(85, 40) -- (84, 90)node [black, midway, right=10pt] {\scriptsize{$\bm{ {\color{darkcyan}ATT} + {\color{SFUgold}a} }$}};
...
(85, 15) -- (85, 35)node [SFUgold, midway, right=10pt] {\footnotesize{$\bm{ a }$}};
...
\end{tikzpicture}
%\end{center}
%\caption{DiD estimation decomposition}
%\end{figure}
%
%\end{document}