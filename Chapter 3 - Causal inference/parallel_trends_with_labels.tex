...
\addplot[DarkRed, dashed, domain = 15:85]{15};
...
%\addplot[thick, darkcyan, no marks, domain = 15:85] { (5/7)*x + 29.28571};
...
% Curly brackets to describe ATT = delta
%\draw [darkcyan, thick, decorate, decoration={brace, raise = 5pt, amplitude = 5pt, mirror}]
%(85, 60) -- (85, 90)node [darkcyan, midway, right=10pt] {\footnotesize{$\delta$}};

% Curly brackets to describe ATT = delta + lambda
\draw [darkcyan, thick, decorate, decoration={brace, raise = 5pt, amplitude = 5pt, mirror}]
(85, 40) -- (84, 90)node [black, midway, right=10pt] {\scriptsize{$\bm{ {\color{darkcyan}\delta} + {\color{SFUgold}\lambda} }$}};
...
%(85, 35) -- (85, 60)node [orange, midway, right=10pt] {\footnotesize{$\tau$}};

\draw [orange, thick, decorate, decoration={brace, raise = 5pt, amplitude = 5pt, mirror}]
(15, 15) -- (15, 40)node [orange, midway, right=10pt] {\footnotesize{$\bm{ \tau }$}};
...
(15, 0) -- (15, 15)node [darkolivegreen, midway, right=10pt] {\footnotesize{$\bm{ \beta_0 }$}};
...
(85, 15) -- (85, 35)node [SFUgold, midway, right=10pt] {\footnotesize{$\bm{ \lambda }$}};
...
\end{tikzpicture}
%\end{center}
%\caption[Parallel trends]{DiD regression decomposition}
%\end{figure}
%
%\end{document}